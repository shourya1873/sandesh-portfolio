...
import { generateBlogMetadata, generateArticleStructuredData, generateBreadcrumbStructuredData, getBaseUrl } from "@/lib/seo"
...
export default async function BlogPage({ params }: BlogPageProps) {
    ...
    const articleStructuredData = generateArticleStructuredData(blog)
